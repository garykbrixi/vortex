...
def generate_and_score(
    sequences, generator, tokenizer, args, generations_per_prompt=5, device="cuda:0"
):
    """
...
def calculate_sequence_identity(
    seq1: str, seq2: str, amino_acids=False
) -> Optional[float]:
...
def main():
    ...
    parser.add_argument(
        "--num_tokens", default=100, help="Number of tokens to generate."
    )
    ...
    g = Generator(
        m, tokenizer, top_k=args.top_k, top_p=args.top_p, temperature=args.temperature
    )
