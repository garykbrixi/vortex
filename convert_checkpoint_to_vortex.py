...
KEY_UPDATE_DICT_HYENA = {
    ...
    "mixer.mixer.long_conv_bias": "filter.D",
...
def convert_module_state_dict(state_dict, module):
    ...
    if operator_type == "hyena" or operator_type == "hyena_medium_conv":
        ...
        if operator_type == "hyena":
            new_state_dict["filter.poles"] = new_state_dict["mixer.mixer.filter.p"]
            new_state_dict["filter.residues"] = new_state_dict["mixer.mixer.filter.R"]
            ...
            # parametrization in medium_conv matches!
...
if __name__ == "__main__":
    ...
    iteration = 205_000
    new_checkpoint_path = '/scratch/hielab/gbrixi/evo2/nvidia/7b_stripedhyena2_base_4M_resume/'
